...
<table width="100%" border="0" cellpadding="0" cellspacing="0"">
  ...
  <tr> 
    <td height="25" bgcolor="#CCCCCC" colspan="0">&nbsp;<b><font size="<? echo $FONTSIZE_TITLE3 ?>" color="#000000">Status</font></b></td>
  </tr>
  <tr> 
   <td bgcolor="<? echo $TABLE_COLOR2 ?>" height="20" colspan="2"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="30">&nbsp;&nbsp;&nbsp;<img src="images/status_green.gif" width="9" height="11" alt="Ware ist sofort lieferbar">&nbsp;&nbsp;&nbsp;<font size="<? echo $FONTSIZE_NORMAL ?>"> 
            <? echo $status_green ?>
            </font></td>
        </tr>
        <tr> 
          <td height="30">&nbsp;&nbsp;&nbsp;<img src="images/status_yellow.gif" width="9" height="11" alt="Ware ist bestellt">&nbsp;&nbsp;&nbsp;<font size="<? echo $FONTSIZE_NORMAL ?>"> 
            <? echo $status_yellow ?>
            </font></td>
        </tr>
        <tr> 
          <td height="30">&nbsp;&nbsp;&nbsp;<img src="images/status_red.gif" width="9" height="11" alt="Ware ist z.Z. nicht lieferbar">&nbsp;&nbsp;&nbsp;<font size="<? echo $FONTSIZE_NORMAL ?>"> 
            <? echo $status_red ?>
            </font></td>
        </tr>
        </table>
